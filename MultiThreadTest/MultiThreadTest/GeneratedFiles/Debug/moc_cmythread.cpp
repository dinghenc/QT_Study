...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CMyThread_t, stringdata0) + ofs \
...
const QMetaObject CMyThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CMyThread.data,
...
void *CMyThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CMyThread.stringdata0))
