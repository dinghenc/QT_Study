...
const QMetaObject TCPSever::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TCPSever.data,
      qt_meta_data_TCPSever,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TCPSever::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TCPSever.stringdata0))
        return static_cast<void*>(const_cast< TCPSever*>(this));
